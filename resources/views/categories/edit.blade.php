                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center space-x-4">
                                    ...
                                    <input type="text" name="color_text" id="color_text" value="{{ old('color', $category->color) }}" 
                            ...
                            <div>
                                ...
                                <div class="border border-gray-200 rounded-md p-4 bg-gray-50">
                                    <div class="flex items-center">
                                        <div class="w-4 h-4 rounded-full mr-3" id="preview-color" style="background-color: {{ old('color', $category->color) }};"></div>
                                        <span class="text-sm font-medium" id="preview-name">{{ old('name', $category->name) }}</span>
                                    </div>
                                    <p class="text-sm text-gray-600 mt-2" id="preview-description">{{ old('description', $category->description) }}</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-md">
                                ...
                                <div class="text-xs text-gray-500 space-y-1">
                                    ...
                                    <p>Diupdate: {{ $category->updated_at->format('d M Y H:i') }}</p>
                                    <p>Jumlah Posting: {{ $category->posts()->count() }}</p>
                                </div>
                            </div>
