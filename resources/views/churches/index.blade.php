                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            @if($church->logo)
                                <img src="{{ Storage::url($church->logo) }}" alt="{{ $church->name }}" class="w-12 h-12 rounded-full mr-4">
                            @else
                            ...
                            @endif
                            <div>
                                <h4 class="text-xl font-semibold text-gray-900">{{ $church->name }}</h4>
                                <p class="text-gray-600">{{ $church->city }}, {{ $church->province }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 mb-4">
                            @if($church->address)
                                <p class="text-sm text-gray-600">
                                    <i class="fas fa-map-marker-alt mr-2"></i>{{ $church->address }}
                                </p>
                            @endif
                            @if($church->phone)
                                <p class="text-sm text-gray-600">
